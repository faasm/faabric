...
namespace faabric::endpoint {
    ...
    void FaabricEndpointHandler::onRequest(const Pistache::Http::Request &request, Pistache::Http::ResponseWriter response) {
    ...
    std::string FaabricEndpointHandler::handleFunction(const std::string &requestStr) {
